    ...
    while(1)
    {
        ...
        switch(Token.token_rep)
        {
            case _hold:
            {
                ...
                encode_declare_section(Text, declare_type, current_scope);
            ...
            case _extern:
            {
                ...
                switch(current_scope) {
                    case scope_universal:     insert_universal_scope(Text, tool_extern, declare_type);     break;  
                    case scope_global:        insert_global_scope(Text, tool_extern, declare_type);        break;
                    case scope_global_param:  insert_global_param_scope(Text, tool_extern, declare_type);  break;
                    case scope_global_block:  insert_global_block_scope(Text, tool_extern, declare_type);  break;
                    case scope_local:         insert_local_scope(Text, tool_extern, declare_type);         break;
                    case scope_local_param:   insert_local_param_scope(Text, tool_extern, declare_type);   break; 
                    case scope_local_block:   insert_local_block_scope(Text, tool_extern, declare_type);   break;
                    default:  error("seeding error: declare error: Invalid scope for declaration"); break;
                }
               encode_declare_section(Text, tool_extern, current_scope);
